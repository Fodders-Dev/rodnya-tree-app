...
* **11.09 — SPEED-15 в проде** (`6905e0d3`, sonnet-агент, слияние по «го»):
  ...
  массовый логаут. Дамп `pre-speed15-20260911-133419.dump`. Находка: зеркало
  графа копит надгробия (392) и мёртвые `legacyPersonIds` (1364 у одной
  записи) — 434 КБ, кандидат SPEED-16. Бэкенд 784/784.
